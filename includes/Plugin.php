...
class TkEventWeather__Plugin extends TkEventWeather__LifeCycle {
    ...
    public function customizer_options( $wp_customize ) {
    		...
    		$wp_customize->add_section( self::$customizer_section_id,
    			...
    			// UTC Offset Type
    			$wp_customize->add_setting( self::$customizer_flag . '[utc_offset_type]', array(
    				'type'              => 'option',
    				'capability'        => 'edit_theme_options',
    				'default'           => '',
    			));
    			
    			$wp_customize->add_control( self::$customizer_flag . '_utc_offset_type_control', array(
      			'label'       => esc_html__( 'UTC Offset Type', 'tk-event-weather' ),
    				...
    				'section'     => self::$customizer_section_id,
    				'settings'    => self::$customizer_flag . '[utc_offset_type]',
    				'type'		    => 'select',
