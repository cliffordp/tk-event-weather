...
class Plugin extends Life_Cycle {
	...
	public function upgrade() {
		...
		if ( $this->is_version_less_than( $saved_version, '1.5.0' ) ) {
			...
			$current_options = get_option( TK_EVENT_WEATHER_PLUGIN_SLUG );
			$needs_update    = false;
			...
			if ( $needs_update ) {
				update_option( TK_EVENT_WEATHER_PLUGIN_SLUG, $current_options );
			}
		}
	...
	public function customizer_options( \WP_Customize_Manager $wp_customize ) {
		...
		$wp_customize->add_setting(
			TK_EVENT_WEATHER_PLUGIN_SLUG . '[display_template]', array(
				'type'    => 'option',
				'default' => '',
			)
		);
		...
		$wp_customize->add_control(
			TK_EVENT_WEATHER_PLUGIN_SLUG . '_display_template_control', array(
				...
				'settings'    => TK_EVENT_WEATHER_PLUGIN_SLUG . '[display_template]',
				'type'        => 'select',
		...
		$wp_customize->add_setting(
			TK_EVENT_WEATHER_PLUGIN_SLUG . '[scroll_horizontal_off]', array(
				'type'    => 'option',
				'default' => '',
			)
		);
		...
		$wp_customize->add_control(
			TK_EVENT_WEATHER_PLUGIN_SLUG . '_scroll_horizontal_off_control', array(
				...
				'section'     => self:: $customizer_section_id . '_display',
				'settings'    => TK_EVENT_WEATHER_PLUGIN_SLUG . '[scroll_horizontal_off]',
				'type'        => 'checkbox',
		...
		$wp_customize->add_setting(
			TK_EVENT_WEATHER_PLUGIN_SLUG . '[vertical_to_columns_off]', array(
				'type'    => 'option',
				'default' => '',
			)
		);
		...
		$wp_customize->add_control(
			TK_EVENT_WEATHER_PLUGIN_SLUG . '_vertical_to_columns_off_control', array(
				...
				'section'     => self:: $customizer_section_id . '_display',
				'settings'    => TK_EVENT_WEATHER_PLUGIN_SLUG . '[vertical_to_columns_off]',
				'type'        => 'checkbox',
				'choices'     => array( 'true' => __( 'Disable', 'tk-event-weather' ) ),
			)
		);
		...
		$wp_customize->add_setting(
			TK_EVENT_WEATHER_PLUGIN_SLUG . '[sunrise_sunset_off]', array(
				'type'    => 'option',
				'default' => '',
			)
		);
		...
		$wp_customize->add_control(
			TK_EVENT_WEATHER_PLUGIN_SLUG . '_sunrise_sunset_off_control', array(
				...
				'section'     => self:: $customizer_section_id . '_display',
				'settings'    => TK_EVENT_WEATHER_PLUGIN_SLUG . '[sunrise_sunset_off]',
				'type'        => 'checkbox',
				'choices'     => array( 'true' => __( 'Disable', 'tk-event-weather' ) ),
			)
		);
		...
		// Before Text
		$wp_customize->add_setting(
			TK_EVENT_WEATHER_PLUGIN_SLUG . '[text_before]', array(
				'type'              => 'option',
				'default'           => '',
		...
		$wp_customize->add_control(
			TK_EVENT_WEATHER_PLUGIN_SLUG . '_text_before_control', array(
				...
				'section'     => self:: $customizer_section_id . '_display',
				'settings'    => TK_EVENT_WEATHER_PLUGIN_SLUG . '[text_before]',
				'type'        => 'text',
			)
		);
		...
		// After Text
		$wp_customize->add_setting(
			TK_EVENT_WEATHER_PLUGIN_SLUG . '[text_after]', array(
				'type'              => 'option',
				'default'           => '',
				'sanitize_callback' => 'sanitize_text_field',
			)
		...
		$wp_customize->add_control(
			TK_EVENT_WEATHER_PLUGIN_SLUG . '_text_after_control', array(
				...
				'section'     => self:: $customizer_section_id . '_display',
				'settings'    => TK_EVENT_WEATHER_PLUGIN_SLUG . '[text_after]',
				'type'        => 'text',
			)
		);
		...
		$wp_customize->add_setting(
			TK_EVENT_WEATHER_PLUGIN_SLUG . '[time_format_day]', array(
				'type'              => 'option',
				'default'           => '',
				'sanitize_callback' => 'sanitize_text_field',
			)
		...
		$wp_customize->add_control(
			TK_EVENT_WEATHER_PLUGIN_SLUG . '_time_format_day_control', array(
				...
				'section'     => self:: $customizer_section_id . '_display',
				'settings'    => TK_EVENT_WEATHER_PLUGIN_SLUG . '[time_format_day]',
				'type'        => 'text',
			)
		);
		...
		// Hours Time Format
		$wp_customize->add_setting(
			TK_EVENT_WEATHER_PLUGIN_SLUG . '[time_format_hours]', array(
				'type'              => 'option',
				'default'           => '',
				'sanitize_callback' => 'sanitize_text_field',
			)
		...
		$wp_customize->add_control(
			TK_EVENT_WEATHER_PLUGIN_SLUG . '_time_format_hours_control', array(
				...
				'section'     => self:: $customizer_section_id . '_display',
				'settings'    => TK_EVENT_WEATHER_PLUGIN_SLUG . '[time_format_hours]',
				'type'        => 'text',
			)
		);
		...
		$wp_customize->add_setting(
			TK_EVENT_WEATHER_PLUGIN_SLUG . '[time_format_minutes]', array(
				'type'              => 'option',
				'default'           => '',
				'sanitize_callback' => 'sanitize_text_field',
			)
		...
		$wp_customize->add_control(
			TK_EVENT_WEATHER_PLUGIN_SLUG . '_time_format_minutes_control', array(
				...
				'section'     => self:: $customizer_section_id . '_display',
				'settings'    => TK_EVENT_WEATHER_PLUGIN_SLUG . '[time_format_minutes]',
				'type'        => 'text',
			)
		);
		...
		$wp_customize->add_setting(
			TK_EVENT_WEATHER_PLUGIN_SLUG . '[plugin_credit_link_on]', array(
				'type'    => 'option',
				'default' => '',
			)
		);
		...
		$wp_customize->add_control(
			TK_EVENT_WEATHER_PLUGIN_SLUG . '_plugin_credit_link_on_control', array(
				...
				'section'     => self:: $customizer_section_id . '_display',
				'settings'    => TK_EVENT_WEATHER_PLUGIN_SLUG . '[plugin_credit_link_on]',
				'type'        => 'checkbox',
		...
		$wp_customize->add_setting(
			TK_EVENT_WEATHER_PLUGIN_SLUG . '[darksky_credit_link_off]', array(
				'type'    => 'option',
				'default' => '',
			)
		);
		...
		$wp_customize->add_control(
			TK_EVENT_WEATHER_PLUGIN_SLUG . '_darksky_credit_link_off_control', array(
				...
				'section'     => self:: $customizer_section_id . '_display',
				'settings'    => TK_EVENT_WEATHER_PLUGIN_SLUG . '[darksky_credit_link_off]',
				'type'        => 'checkbox',
				'choices'     => array( 'true' => __( 'Disable', 'tk-event-weather' ) ),
			)
		);
		...
		$wp_customize->add_setting(
			TK_EVENT_WEATHER_PLUGIN_SLUG . '[darksky_api_key]', array(
				'type'              => 'option',
				'default'           => '',
		...
		$wp_customize->add_control(
			TK_EVENT_WEATHER_PLUGIN_SLUG . '_darksky_api_key_control', array(
				...
				'settings'    => TK_EVENT_WEATHER_PLUGIN_SLUG . '[darksky_api_key]',
				'type'        => 'password',
				/**
		...
		// Multi-Day control
		$wp_customize->add_setting(
			TK_EVENT_WEATHER_PLUGIN_SLUG . '[multi_day_limit]', array(
				'type'              => 'option',
				'default'           => '',
		...
		$wp_customize->add_control(
			TK_EVENT_WEATHER_PLUGIN_SLUG . '_multi_day_limit_control', array(
				...
				'section'     => self:: $customizer_section_id . '_api_dark_sky',
				'settings'    => TK_EVENT_WEATHER_PLUGIN_SLUG . '[multi_day_limit]',
				'type'        => 'text',
			)
		);
		...
		$wp_customize->add_setting(
			TK_EVENT_WEATHER_PLUGIN_SLUG . '[multi_day_ignore_start_at_today]', array(
				'type'    => 'option',
				'default' => '',
			)
		);
		...
		$wp_customize->add_control(
			TK_EVENT_WEATHER_PLUGIN_SLUG . '_multi_day_ignore_start_at_today_control', array(
				...
				'section'     => self:: $customizer_section_id . '_api_dark_sky',
				'settings'    => TK_EVENT_WEATHER_PLUGIN_SLUG . '[multi_day_ignore_start_at_today]',
				'type'        => 'checkbox',
				'choices'     => array( 'true' => __( 'Disable', 'tk-event-weather' ) ),
			)
		);
		...
		// Past cutoff days
		$wp_customize->add_setting(
			TK_EVENT_WEATHER_PLUGIN_SLUG . '[cutoff_past_days]', array(
				'type'              => 'option',
				'default'           => '',
				'sanitize_callback' => array( 'Functions', 'sanitize_absint_allow_blank' ),
			)
		...
		$wp_customize->add_control(
			TK_EVENT_WEATHER_PLUGIN_SLUG . '_cutoff_past_days_control', array(
				...
				'section'     => self:: $customizer_section_id . '_api_dark_sky',
				'settings'    => TK_EVENT_WEATHER_PLUGIN_SLUG . '[cutoff_past_days]',
				'type'        => 'text',
			)
		);
		...
		// Future cutoff days
		$wp_customize->add_setting(
			TK_EVENT_WEATHER_PLUGIN_SLUG . '[cutoff_future_days]', array(
				'type'              => 'option',
				'default'           => '',
				'sanitize_callback' => array( 'Functions', 'sanitize_absint_allow_blank' ),
			)
		...
		$wp_customize->add_control(
			TK_EVENT_WEATHER_PLUGIN_SLUG . '_cutoff_future_days_control', array(
				...
				'section'     => self:: $customizer_section_id . '_api_dark_sky',
				'settings'    => TK_EVENT_WEATHER_PLUGIN_SLUG . '[cutoff_future_days]',
				'type'        => 'text',
			)
		);
		...
		// Units
		$wp_customize->add_setting(
			TK_EVENT_WEATHER_PLUGIN_SLUG . '[darksky_units]', array(
				'type'    => 'option',
				'default' => '',
			)
		);
		...
		$wp_customize->add_control(
			TK_EVENT_WEATHER_PLUGIN_SLUG . '_darksky_units_control', array(
				...
				'section'     => self:: $customizer_section_id . '_api_dark_sky',
				'settings'    => TK_EVENT_WEATHER_PLUGIN_SLUG . '[darksky_units]',
				'type'        => 'select',
		...
		// Language
		$wp_customize->add_setting(
			TK_EVENT_WEATHER_PLUGIN_SLUG . '[darksky_language]', array(
				'type'    => 'option',
				'default' => '',
			)
		);
		...
		$wp_customize->add_control(
			TK_EVENT_WEATHER_PLUGIN_SLUG . '_darksky_language_control', array(
				...
				'section'     => self:: $customizer_section_id . '_api_dark_sky',
				'settings'    => TK_EVENT_WEATHER_PLUGIN_SLUG . '[darksky_language]',
				'type'        => 'select',
		...
		// Timezone Sources
		$wp_customize->add_setting(
			TK_EVENT_WEATHER_PLUGIN_SLUG . '[timezone_source]', array(
				'type'    => 'option',
				'default' => '',
			)
		);
		...
		$wp_customize->add_control(
			TK_EVENT_WEATHER_PLUGIN_SLUG . '_timezone_source_control', array(
				...
				'section'     => self:: $customizer_section_id . '_api_dark_sky',
				'settings'    => TK_EVENT_WEATHER_PLUGIN_SLUG . '[timezone_source]',
				'type'        => 'select',
		...
		// e.g. AIza...URyTxC0w
		$wp_customize->add_setting(
			TK_EVENT_WEATHER_PLUGIN_SLUG . '[google_maps_api_key]', array(
				'type'    => 'option',
				'default' => '',
		...
		$wp_customize->add_control(
			TK_EVENT_WEATHER_PLUGIN_SLUG . '_google_maps_api_key_control', array(
				...
				'settings'    => TK_EVENT_WEATHER_PLUGIN_SLUG . '[google_maps_api_key]',
				'type'        => 'password',
				'input_attrs' => array(
					'data-lpignore' => 'true',
					'autocomplete'  => 'new-password',
		...
		$wp_customize->add_setting(
			TK_EVENT_WEATHER_PLUGIN_SLUG . '[transients_expiration_hours]', array(
				'type'              => 'option',
				'default'           => '',
				'sanitize_callback' => array( 'Functions', 'sanitize_absint_allow_blank' ),
			)
		...
		$wp_customize->add_control(
			TK_EVENT_WEATHER_PLUGIN_SLUG . '_transients_expiration_hours_control', array(
				...
				'settings'    => TK_EVENT_WEATHER_PLUGIN_SLUG . '[transients_expiration_hours]',
				'type'        => 'text',
			)
		);
		...
		// Disable transients
		$wp_customize->add_setting(
			TK_EVENT_WEATHER_PLUGIN_SLUG . '[transients_off]', array(
				'type'    => 'option',
				'default' => '',
			)
		);
		...
		$wp_customize->add_control(
			TK_EVENT_WEATHER_PLUGIN_SLUG . '_transients_off_control', array(
				...
				'section'     => self:: $customizer_section_id . '_advanced',
				'settings'    => TK_EVENT_WEATHER_PLUGIN_SLUG . '[transients_off]',
				'type'        => 'checkbox',
				'choices'     => array( 'true' => __( 'Disable', 'tk-event-weather' ) ),
			)
		);
		...
		// Enable Debug Mode
		$wp_customize->add_setting(
			TK_EVENT_WEATHER_PLUGIN_SLUG . '[debug_on]', array(
				'type'    => 'option',
				'default' => '',
			)
		);
		...
		$wp_customize->add_control(
			TK_EVENT_WEATHER_PLUGIN_SLUG . '_debug_on_control', array(
				...
				'section'     => self:: $customizer_section_id . '_advanced',
				'settings'    => TK_EVENT_WEATHER_PLUGIN_SLUG . '[debug_on]',
				'type'        => 'checkbox',
				'choices'     => array( 'true' => __( 'Enable', 'tk-event-weather' ) ),
			)
		);
		...
		$wp_customize->add_setting(
			TK_EVENT_WEATHER_PLUGIN_SLUG . '[uninstall_delete_all_data]', array(
				'type'    => 'option',
				'default' => '',
			)
		);
		...
		$wp_customize->add_control(
			TK_EVENT_WEATHER_PLUGIN_SLUG . '_uninstall_delete_all_data_control', array(
				...
				'section'     => self:: $customizer_section_id . '_advanced',
				'settings'    => TK_EVENT_WEATHER_PLUGIN_SLUG . '[uninstall_delete_all_data]',
				'type'        => 'checkbox',
				'choices'     => array( 'true' => __( 'Enable', 'tk-event-weather' ) ),
			)
		);
		...
		/*
					// Icons
					$wp_customize->add_setting( TK_EVENT_WEATHER_PLUGIN_SLUG . '[icons]', array(
						'type'				=> 'option',
						'default'			=> '',
					));

					$wp_customize->add_control( TK_EVENT_WEATHER_PLUGIN_SLUG . '_icons_control', array(
